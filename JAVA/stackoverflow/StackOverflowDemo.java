...
public class StackOverflowDemo {
    public static void run(){
        ...
        Answer bobAnswer = system.ansQuestion(bob, javaQuestion,
        ...
        Answer aliceAnswer = system.ansQuestion(alice, pythonQuestion,
        ...
        System.out.println("\nBob's Questions:");
        List<Question> bobQuestions = system.getQuestionsByAuthor(bob);
